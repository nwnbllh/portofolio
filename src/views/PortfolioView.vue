  ...
  data() {
    return {
      ...
      items: [
        {
          id: 1,
          name: 'Pamphlate Banner',
          imageUrl: 'portfolio_v2',
          status: 'This art festival invites us to redefine the meaning of ports, no longer being transit ports, but becoming destinations of choice for every terminal visitor, whether they want to cross. Organized by the Corporate Secretary of PT ASDP Indonesia Ferry (Persero).',
          tech: 'AI, Corel',
          github: 'null',
          demo: 'nuul'
        },
        {
          ...
          status: 'Momochi is a company operating in the FnB sector which sells various types of mochi desserts (a typical Japanese food with a sticky texture) with various fillings ranging from chocolate, strawberry, matcha, ice cream, fruit and original.',
          tech: 'Figma',
          github: 'null',
          demo: 'null'
        },
        {
          ...
          imageUrl: 'sistekdes',
          status: 'Wedding Practices are wedding practice activities carried out to assess the final results of the twelfth grade exam at vocational high school 53 Jakarta. This is an example of social media content that I created from Instagram @tekaje.24',
          tech: 'Canva, PS',
          github: 'null',
          demo: 'null'
        },
        {
          ...
          name: 'Poster',
          imageUrl: 'bumdesma',
          status: 'Kartini Day is celebrated every April 21 to honor the struggle of Raden Ajeng Kartini or R.A. Kartini in fighting for Indonesian women at that time.',
          tech: 'PS, Ai',
          github: 'null',
          demo: 'null'
        },
        {
          ...
          imageUrl: 'sp2se',
          status: 'I have make Vector illustrasion for Teacher Day, Virtual Yearbook, Feed, Instagram, Id Card Giving, Poster, etc.',
          tech: 'Canva, AI, PS, Corel',
          github: 'null',
          demo: 'null'
        }
      ]
